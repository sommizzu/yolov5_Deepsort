...
def draw_boxes(img, bbox, identities=None, categories=None, names=None, offset=(0, 0), blur_obj=False, color_box=False):
    for i, box in enumerate(bbox):
        ...
        if color_box:
            ...
            color = (0, 255, 0)  # Default color for all objects
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                """tracks = sort_tracker[cls].getTrackers()

                for track in tracks:
                    color = compute_color_for_labels(int(track.detclass))
